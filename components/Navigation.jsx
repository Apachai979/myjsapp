...
export default function Navigation() {
    ...
    function handleMenu() {
        if (state) ulRef.current.className += ' top-[64px] opacity-100 '
    ...
    useEffect(() => {
        const intervalId = setInterval(handleMenu, 1000)
    ...
    return (
        <>
            <ul ref={ulRef} className="rounded-b-3xl sm920:rounded-none sm920:flex sm920:flex-1 sm920:items-center sm920:justify-evenly z-[-1] sm920:z-auto sm920:static absolute bg-gray-200 sm920:bg-body_bg sm920:max-w-[880px] w-full left-0 sm920:w-auto xl:px-8 sm920:px-4 sm920:py-0 py-4 pl-7 text-base sm920:text-sm lg:text-base sm920:opacity-100 opacity-0 top-[-400px] transition-all ease-in duration-500 ">
                ...
                <li className="mx-4 mb-8 mt-4 sm920:my-0 sm920:mx-0 text-center ">

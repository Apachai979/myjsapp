...
const lean = [
    { title: "Производим ровно столько продукции, сколько нужно потребителям", src: "/Manufacture/box.svg" },
    { title: "Гарантируем заказчику быструю и безопасную доставку продукции", src: "/Manufacture/car.svg" },
    { title: "При помощи современных технологий мы научились использовать материальные, временные и трудовые ресурсы максимально эффективно", src: "/Manufacture/technik.svg" },
]
const lean2 = [
    { title: "Стремимся к идеальному качеству продукции при нулевом проценте брака", src: "/Manufacture/serct.svg" },
            ...
            <div className='container mx-auto px-4 max-w-[1200px] my-10'>
                <div className='flex xl:space-x-20 flex-col xl:flex-row space-y-6 xl:space-y-0'>
                    <div className='flex-1 justify-self-end pt-2'>
                        <h1 className='text-6xl font-semibold text-mainGreen text-left xl:text-right'>OneStep <span className='text-txtGreen'>— это:</span></h1>
                    </div>
                    <div className='flex-1 justify-self-start'>
                        <ul className='list-disc list-inside text-2xl text-txtGreen leading-relaxed'>
                            <li>высокотехнологичное оборудование, разработанное с учетом наших требований;</li>
                            <li>сырье от лучших мировых поставщиков;</li>
                            <li>внедрение автоматизации всех процессов на базе системы управления предприятием ERP, позволяющей осуществлять контроль на всех этапах производства;</li>
                            <li>профессионализм, ответственность и увлеченность наших сотрудников</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div className='container mx-auto px-4 max-w-[1200px]'>
                <div className='flex justify-center items-center font-xl text-5xl'>
                    <h1 className='text-center'>
                        Мы придерживаемся принципов <p className='text-primary_green text-center'>"Бережливого производства"</p>
                    </h1>
                </div>
                        ...
                        {lean.map((elem) => {
                            return (
                                <div className='flex flex-row-reverse lg:flex-row justify-end items-center  space-x-2 space-x-reverse lg:space-x lg:space-x-4'>
                                    <p key={elem.title} className=''>{elem.title}</p>
                                    <Image src={elem.src}
                                        width={80}
                                        height={80}
                                        alt='box'
                ...
                <div className='container mx-auto px-4 max-w-[1200px] py-10'>
                    <div className='flex justify-center items-center flex-col lg:flex-row space-y-10 lg:space-y-0 lg:space-x-14'>
                        ...
                        <div className='flex lg:w-6/12 flex-col'>
                            ...
                            <hr className='h-1.5 w-24 bg-txtGreen' />
                            <br />
                            <p className='text-2xl text-txtGreen'>Складские мощности позволяют обеспечить производство сырьем на несколько месяцев бесперебойной работы.</p>
                            <br />
                            <p className='text-2xl text-txtGreen'>Также, возможности складского хранения позволяют иметь в наличии достаточное количество готовой продукции, необходимой для наших заказчиков.</p>
                            <br />
